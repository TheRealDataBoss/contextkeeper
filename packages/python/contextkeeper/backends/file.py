"""Filesystem-based backend for contextkeeper."""
...
logger = logging.getLogger("contextkeeper.backends.file")

_CK_DIR = ".contextkeeper"


class FileBackend(ContextKeeperBackend):
    """Stores contextkeeper data as JSON files on the local filesystem.
