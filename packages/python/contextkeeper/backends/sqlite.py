"""SQLite-based backend for contextkeeper."""
...
logger = logging.getLogger("contextkeeper.backends.sqlite")

_CK_DIR = ".contextkeeper"
_DB_NAME = "contextkeeper.db"
...
class SQLiteBackend(ContextKeeperBackend):
    """Stores contextkeeper data in a SQLite database.

    Storage: ``<root>/.contextkeeper/contextkeeper.db``
    """
