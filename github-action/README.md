# Workbench AI — GitHub Action

Automatically sync your project's STATE_VECTOR.json and HANDOFF.md to your workbench bridge repo on every push, merge, or release.

## Usage

Add to `.github/workflows/workbench-sync.yml`:
...
2. Add it as a repository secret named `WORKBENCH_TOKEN`
...
5. Commits and pushes with message: `chore(workbench): sync <project> -- <timestamp>`
