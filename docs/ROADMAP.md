...
- npm CLI scaffold (workbench-ai)
- Python CLI scaffold (workbench-ai)
...
- Hosted bridge option (workbench.ai SaaS) as alternative to GitHub bridge repo
